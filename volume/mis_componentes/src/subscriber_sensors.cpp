...
{
public:
    RobotSensorsSubscriber(const rclcpp::NodeOptions & options)
        : Node("subscriber_sensors", options)
    {
...
RCLCPP_COMPONENTS_REGISTER_NODE(mis_componentes::RobotSensorsSubscriber)
